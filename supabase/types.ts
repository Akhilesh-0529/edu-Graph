  ...
  public: {
    Tables: {
      ...
      graph_links: {
        ...
        Relationships: [
          {
            foreignKeyName: "graph_links_graph_id_fkey"
            columns: ["graph_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "graph_links_source_node_id_fkey"
          ...
          {
            foreignKeyName: "graph_links_target_node_id_fkey"
      ...
      graph_node_files: {
        ...
        Relationships: [
          {
            foreignKeyName: "graph_node_files_file_id_fkey"
            columns: ["file_id"]
            isOneToOne: false
            referencedRelation: "files"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "graph_node_files_node_id_fkey"
            columns: ["node_id"]
            isOneToOne: false
            referencedRelation: "graph_nodes"
            referencedColumns: ["id"]
      ...
      graph_workspaces: {
        ...
        Relationships: [
          {
            foreignKeyName: "graph_workspaces_graph_id_fkey"
            columns: ["graph_id"]
            isOneToOne: false
            referencedRelation: "graphs"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "graph_workspaces_workspace_id_fkey"
            columns: ["workspace_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
      ...
      graphs: {
        ...
        Relationships: [
          {
            foreignKeyName: "graphs_folder_id_fkey"
            columns: ["folder_id"]
            isOneToOne: false
            referencedRelation: "folders"
            referencedColumns: ["id"]
